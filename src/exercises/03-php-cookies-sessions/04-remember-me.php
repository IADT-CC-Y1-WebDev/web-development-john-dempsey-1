...
<body>
    ...
    <div class="output">
        ...
        echo "<ol>";
        echo "<li>The session is used to keep track of the user's logged-in state on the server. 
           It allows the server to remember who the user is across different page requests 
           without needing to login again. The session data is stored on the server, and 
           the client only holds a session ID in a cookie.";
        echo "</li>";
        echo "<li>The cookie is used to remember the user's identity on the client side, even after
           the browser is closed. This allows for a 'Remember Me' functionality, where the user
           can be recognized and logged in automatically when they return to the site, without
           needing to enter their credentials again.";
        echo "</li>";
        echo "<li>Using both together allows for a more seamless user experience. The session manages
           the active login state while the user is browsing, while the cookie allows for persistent
           recognition across browser sessions. This way, users can choose to be remembered without
           having to log in every time they visit the site, while still maintaining security and 
           control over their login state.</li>";
        echo "</ol>";
        ?>
    </div>
