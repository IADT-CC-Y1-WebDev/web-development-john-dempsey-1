...
if ($cookieTheme !== 'not set' && isset($themes[$cookieTheme])) {
    $currentTheme = $themes[$cookieTheme];
} elseif ($sessionTheme !== 'not set' && isset($themes[$sessionTheme])) {
    $currentTheme = $themes[$sessionTheme];
} else {
    $currentTheme = ['bg' => '#ffffff', 'text' => '#333333']; // default
}
// =============================================================================
?>
<!DOCTYPE html>
...
?>
<body style="background: <?= $currentTheme['bg'] ?>; color: <?= $currentTheme['text'] ?>;">
<?php
// =============================================================================
?>
    <div class="back-link">
